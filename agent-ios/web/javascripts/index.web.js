...
var DebugButton = require('components/index/DebugButton');
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        { className: 'App' },
        React.createElement(DebugButton, { url: 'https://help.creativesurvey.com/api/v1/entries' }),
        React.createElement(DebugButton, { url: 'https://help.creativesurvey.com/api/v1/entriessss' })
      );
    }
  }]);
...
},{"components/index/DebugButton":163,"react":159}],163:[function(require,module,exports){
'use strict';
...
var DebugButton = (function (_React$Component) {
  _inherits(DebugButton, _React$Component);

  function DebugButton(props) {
    _classCallCheck(this, DebugButton);

    _get(Object.getPrototypeOf(DebugButton.prototype), 'constructor', this).call(this, props);
    this.state = {
      response: '',
      isSending: false
    };
  ...
  _createClass(DebugButton, [{
    key: 'clickHdl',
    value: function clickHdl() {
      var _this = this;

      var request = Request[this.props.method](this.props.url);

      if (this.props.payload) request = request.send(payload);
    ...
    key: 'resolveResponse',
    value: function resolveResponse() {
      if (this.state.isSending) {
        return 'Sending...';
      } else {
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'pre',
          { className: 'DebugButton__Response' },
...
},{"react":159,"superagent":161}],164:[function(require,module,exports){
'use strict';

var React = require('react');
var ReactDOM = require('react-dom');
var ReactDOMServer = require('react-dom/server');
var App = require('components/index/App');
...
if (document) {
  ...
  global.template = ReactDOMServer.renderToString(React.createElement(App, null));
}

},{"components/index/App":162,"react":159,"react-dom":2,"react-dom/server":3}]},{},[164]);
